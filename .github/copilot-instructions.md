...
When bookmarks then name of the bookmarked item should just be ‘Po****’ (ex. PoSomeApp)
...
Enforce a minimum 80% line coverage threshold for all new business logic and no more than 50 tests total in the entire solution
